...
import { UserCryptoProfileOrderByWithAggregationInput } from "./user-crypto-profile-order-by-with-aggregation.input";
import { UserCryptoProfileScalarFieldEnum } from "./user-crypto-profile-scalar-field.enum";
import { UserCryptoProfileScalarWhereWithAggregatesInput } from "./user-crypto-profile-scalar-where-with-aggregates.input";
...
@ArgsType()
export class UserCryptoProfileGroupByArgs {
    @Field(() => UserCryptoProfileWhereInput, { nullable: true })
    @Type(() => UserCryptoProfileWhereInput)
    where?: UserCryptoProfileWhereInput;

    @Field(() => [UserCryptoProfileOrderByWithAggregationInput], {
        nullable: true,
    })
    orderBy?: Array<UserCryptoProfileOrderByWithAggregationInput>;

    @Field(() => [UserCryptoProfileScalarFieldEnum], { nullable: false })
    by!: Array<keyof typeof UserCryptoProfileScalarFieldEnum>;

    @Field(() => UserCryptoProfileScalarWhereWithAggregatesInput, {
        nullable: true,
    })
    having?: UserCryptoProfileScalarWhereWithAggregatesInput;
