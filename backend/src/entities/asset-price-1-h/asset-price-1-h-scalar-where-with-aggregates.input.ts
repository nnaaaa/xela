...
@InputType()
export class asset_price_1hScalarWhereWithAggregatesInput {
    @Field(() => [asset_price_1hScalarWhereWithAggregatesInput], {
        nullable: true,
    })
    AND?: Array<asset_price_1hScalarWhereWithAggregatesInput>;

    @Field(() => [asset_price_1hScalarWhereWithAggregatesInput], {
        nullable: true,
    })
    OR?: Array<asset_price_1hScalarWhereWithAggregatesInput>;

    @Field(() => [asset_price_1hScalarWhereWithAggregatesInput], {
        nullable: true,
    })
    NOT?: Array<asset_price_1hScalarWhereWithAggregatesInput>;
