...
@ArgsType()
export class FindFirstassetPrice1HOrThrowArgs {
    ...
    @Field(() => [Asset_price_1hScalarFieldEnum], { nullable: true })
    distinct?: Array<keyof typeof Asset_price_1hScalarFieldEnum>;
}
