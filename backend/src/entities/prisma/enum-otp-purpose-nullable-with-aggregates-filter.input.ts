...
import { NestedEnumOtpPurposeNullableWithAggregatesFilter } from "./nested-enum-otp-purpose-nullable-with-aggregates-filter.input";
import { NestedIntNullableFilter } from "./nested-int-nullable-filter.input";
import { NestedEnumOtpPurposeNullableFilter } from "./nested-enum-otp-purpose-nullable-filter.input";

@InputType()
export class EnumOtpPurposeNullableWithAggregatesFilter {
