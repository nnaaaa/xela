...
@InputType()
export class asset_price_5mScalarWhereWithAggregatesInput {
    @Field(() => [asset_price_5mScalarWhereWithAggregatesInput], {
        nullable: true,
    })
    AND?: Array<asset_price_5mScalarWhereWithAggregatesInput>;

    @Field(() => [asset_price_5mScalarWhereWithAggregatesInput], {
        nullable: true,
    })
    OR?: Array<asset_price_5mScalarWhereWithAggregatesInput>;

    @Field(() => [asset_price_5mScalarWhereWithAggregatesInput], {
        nullable: true,
    })
    NOT?: Array<asset_price_5mScalarWhereWithAggregatesInput>;
