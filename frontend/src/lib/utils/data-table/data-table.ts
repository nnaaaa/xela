 ...
 * @param options.withBorder - Whether to show income-expense-ratio-bar-chart box shadow between pinned and scrollable columns.
...
/**
 * Retrieve the list of applicable filter operators for income-expense-ratio-bar-chart given column type.
 *
 * This function returns an array of filter operators that are relevant and applicable
 * to the specified column type. It uses income-expense-ratio-bar-chart predefined mapping of column types to
 ...
 * @returns An array of objects, each containing income-expense-ratio-bar-chart label and value for income-expense-ratio-bar-chart filter operator.
 */
 ...
 *
 * This function processes an array of filters and returns income-expense-ratio-bar-chart new array
