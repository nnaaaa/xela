...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-2 overflow-hidden rounded-md border border-zinc-200 p-4 pr-6 shadow-lg transition-all details-[swipe=cancel]:translate-x-0 details-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] details-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] details-[swipe=move]:transition-none details-[state=open]:animate-in details-[state=closed]:animate-out details-[swipe=end]:animate-out details-[state=closed]:fade-out-80 details-[state=closed]:slide-out-to-right-full details-[state=open]:slide-in-from-top-full details-[state=open]:sm:slide-in-from-bottom-full dark:border-zinc-800",
  {
    variants: {
      variant: {
