 ...
 */
export function graphql(
    source: "query GetExpenseCategories($userId: Int!, $startDate: DateTime, $endDate: DateTime) {\n  getExpenseCategories(userId: $userId) {\n    color\n    description\n    name\n    id\n    countExpenses\n    totalAmount(startDate: $startDate, endDate: $endDate)\n  }\n}\n\nmutation CreateExpenseCategory($data: CreateExpenseCategoryInput!) {\n  createExpenseCategory(data: $data) {\n    color\n    description\n    name\n    id\n  }\n}\n\nmutation UpdateExpenseCategory($id: String!, $data: UpdateExpenseCategoryInput!) {\n  updateExpenseCategory(id: $id, data: $data) {\n    color\n    description\n    name\n    id\n  }\n}\n\nmutation RemoveExpenseCategory($id: String!) {\n  removeExpenseCategory(id: $id) {\n    id\n  }\n}",
): (typeof documents)["query GetExpenseCategories($userId: Int!, $startDate: DateTime, $endDate: DateTime) {\n  getExpenseCategories(userId: $userId) {\n    color\n    description\n    name\n    id\n    countExpenses\n    totalAmount(startDate: $startDate, endDate: $endDate)\n  }\n}\n\nmutation CreateExpenseCategory($data: CreateExpenseCategoryInput!) {\n  createExpenseCategory(data: $data) {\n    color\n    description\n    name\n    id\n  }\n}\n\nmutation UpdateExpenseCategory($id: String!, $data: UpdateExpenseCategoryInput!) {\n  updateExpenseCategory(id: $id, data: $data) {\n    color\n    description\n    name\n    id\n  }\n}\n\nmutation RemoveExpenseCategory($id: String!) {\n  removeExpenseCategory(id: $id) {\n    id\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
