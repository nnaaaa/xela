...
import {CreateCryptoProfileInput, CreateCryptoProfileMutation, MutationCreateCryptoProfileArgs} from "@/gql/graphql";
...
export default function ProfileCreator({refresh}: IProps) {
    ...
    const { setError } = form
    const [createProfile] = useMutation<CreateCryptoProfileMutation, MutationCreateCryptoProfileArgs>(CREATE_CRYPTO_PROFILE)
    ...
    return (
        <Dialog open={openDialog} onOpenChange={setOpenDialog}>
            <DialogTrigger asChild>
                <Button variant="outline" size="icon" onClick={() => setOpenDialog(true)}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        />
                        <DialogFooter>
                            <ButtonWithLoading type="submit" loading={loading}>Add</ButtonWithLoading>
                        </DialogFooter>
                    </form>
                </Form>
            </DialogContent>
