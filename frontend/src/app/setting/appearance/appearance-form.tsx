                            ...
                            >
                                <FormItem>
                                    <FormLabel
                                        ...
                                        <div
                                            className='items-center rounded-md border-2 border-muted bg-popover p-1 hover:bg-muted hover:text-muted-foreground'>
                                            <div className='space-y-2 rounded-sm bg-white p-2'>
                                                ...
                                                <div
                                                    className='flex items-center space-x-2 rounded-md bg-gray-300 p-2 shadow-sm'>
